...
class Line_Up_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'lineup_voucher', 'https://platform.lineupnow.com/v2/purchase-loader.bundle.js', array(), $this->version, false );
	...
	public function lineup_voucher_func( $attributes ) {
		...
		return $this->render( 'line-up-voucher-embed-code', $arguments );
	}
}
